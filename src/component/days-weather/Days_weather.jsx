...
const Days_weather = ({latitude, longitude, isDarkMode}) => {
  ...
  return (
    <>
      <div className={`container my-4 mx-16 max-sm:mx-5 max-sm:border max-sm:border-[#000000] rounded-[18px] font-[Poppins] box_shadow w-[28vw] max-sm:w-auto h-auto min-h-[30vh] opacity-[1.3] ${isDarkMode ? "bg-[#444444]" : "bg-primary"}`}>
